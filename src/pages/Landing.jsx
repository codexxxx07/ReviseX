...
export default function Landing({ navigate }) {
  ...
  return (
    <div className={`min-h-screen relative overflow-hidden transition-colors duration-500 ease-in-out ${
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-7xl h-[600px] pointer-events-none opacity-40 dark:opacity-30 z-0">
        <div className="absolute top-[-10%] left-[10%] w-[400px] h-[400px] rounded-full bg-gradient-to-br from-indigo-500 to-purple-500 blur-[120px]" />
        <div className="absolute top-[5%] right-[5%] w-[350px] h-[350px] rounded-full bg-gradient-to-br from-fuchsia-400 to-cyan-400 blur-[100px]" />
      </div>
      ...
      <section className="relative pt-24 pb-20 md:pt-36 md:pb-32 z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-4xl sm:text-6xl md:text-7xl font-extrabold tracking-tight leading-[1.15] mb-6">
            Study Less.{" "}
            <span className="bg-gradient-to-r from-indigo-500 via-purple-500 to-fuchsia-500 bg-clip-text text-transparent drop-shadow-sm animate-gradient-text">
              Score More.
            </span>
          </h1>
      ...
      <section className="relative py-24 z-10" id="features">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            ...
            <div className="w-12 h-1 bg-gradient-to-r from-indigo-500 to-purple-500 mx-auto rounded-full mb-4" />
